...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd><a href="/admin/user/insert">用户</a></dd>
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="/admin/user/profile?userId=${sessionScope.user.userId}">基本资料</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
    ...
    <div class="layui-footer">
        ...
        <p>2019 武汉理工大学 中软国际实习第三小组项目bug组</p>
    </div>
</div>
...
<script>
    ...
    // var aList = document.querySelectorAll('.layui-nav-item a');    //依次获取需要a，.layui-nav-child,i标签
    // var aHide = document.querySelectorAll('.layui-nav-child');
    ...
    //             aList[this.index].className = 'layui-nav-item layui-nav-itemed';
    //         }
    //         else{
    //             aList[this.index].className = 'layui-nav-item';
    //         }
