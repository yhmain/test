    ...
    <form class="layui-form"  method="post" id="myForm" action="/admin/article/insertSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="articleParentCategoryId" id="articleParentCategoryId" lay-verify="required" lay-filter="articleParentCategoryId" required>
            ...
            <div class="layui-input-inline">
                <select name="articleChildCategoryId" id="articleChildCategoryId" lay-verify="required" required>
        ...
        <div class="layui-form-item" pane="">
            ...
            <div class="layui-input-block" id="checkListDiv" lay-verify="checkDiv">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="demo1" name="sub">立即提交</button>
        ...
        layui.use(['form', 'layedit', 'laydate'], function() {
            ...
            form.verify({
                ...
                , content: function (value,item) {
                    // if(document.getElementById("content").value.getLength()<1)
                    //     return "文章内容不能空啊";
                    layedit.sync(editIndex);
                }
                ,checkDiv:function (value,item) {
