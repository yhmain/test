    ...
    <form class="layui-form" method="post" id="myForm" action="/admin/article/editSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="articleParentCategoryId" id="articleParentCategoryId" lay-verify="required" lay-filter="articleParentCategoryId">
            ...
            <div class="layui-input-inline">
                <select name="articleChildCategoryId" id="articleChildCategoryId" lay-verify="required" required lay-filter="articleChildCategoryId">
                    <c:forEach items="${categoryList}" var="c">
